	...
	<div class="card">
	    <div class="card-header" style="border-top: 2px solid red;">
	    	...
	    	<?php
	    		...
	    		if($active_tab_shopinfo == "" && $active_tab_payment == "" &&  $active_tab_currency == "" && $active_tab_sender == "" && $active_tab_tax == "" && $active_tab_policy == "") {
							...
							<div class="form-group">
								...
								<?php 
									echo form_input( array(
										...
										'class' => 'form-control',
										'placeholder' => '',
										'value' =>  set_value( 'lat', show_data( @$shop->lng ), false ),
									));
								?>
							</div>
