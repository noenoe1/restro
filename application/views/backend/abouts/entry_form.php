        	...
        	<div class="card-body">
	            <div class="row">
	              	<div class="col-md-6">
			            ...
			            <div class="form-group">
							<label> <span style="font-size: 17px; color: red;">*</span>
								<?php echo get_msg('privacypolicy')?>
								<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('about_description_tooltips')?>">
									<span class='glyphicon glyphicon-info-sign menu-icon'>
								</a>
							</label>
							<textarea class="form-control" name="privacypolicy" placeholder="Terms & Conditions" rows="5"><?php echo $about->privacypolicy; ?></textarea>
						</div>
	                	<!-- /.form-group -->
			            <div class="form-group">
							<label> <span style="font-size: 17px; color: red;">*</span>
